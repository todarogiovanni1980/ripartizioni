 ...
 * @since  1.6
 */
class TgripartiControllerLettura extends JControllerLegacy
{
	/**
	...
	public function edit()
	{
		...
		// Get the model.
		$model = $this->getModel('Lettura', 'TgripartiModel');
	...
	public function publish()
	{
		...
		if ($user->authorise('core.edit', 'com_tgriparti') || $user->authorise('core.edit.state', 'com_tgriparti'))
		{
			...
			if (!$item)
			{
				...
				$this->setRedirect(JRoute::_('index.php?option=com_tgriparti&view=letture', false));
			}
			else
			{
