...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_tgriparti&task=ricevute.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'ricevutaList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
			...
			<table class="table table-striped" id="ricevutaList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'ricevute.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_tgriparti&task=ricevuta.edit&id='.(int) $item->id); ?>">
