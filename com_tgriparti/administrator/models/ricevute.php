...
/**
	...
	*/
	...
	protected function populateState($ordering = null, $direction = null)
	{
		...
		$this->setState('filter.condominio', $app->getUserStateFromRequest($this->context.'.filter.condominio', 'filter_condominio', '', 'string'));
	...
	public function getItems()
	{
		...
		foreach ($items as $oneItem) {
			...
			if (isset($oneItem->condominio))
			{
				$values = explode(',', $oneItem->condominio);
			...
			$oneItem->condominio = !empty($textValue) ? implode(', ', $textValue) : $oneItem->condominio;
