...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_tgriparti&task=condomini.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'condominioList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
			...
			<table class="table table-striped" id="condominioList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<?php if (isset($this->items[0]->state)): ?>
							<td class="center">
								<?php echo JHtml::_('jgrid.published', $item->state, $i, 'condomini.', $canChange, 'cb'); ?>
</td>
						<?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_tgriparti&task=condominio.edit&id='.(int) $item->id); ?>">
					<?php echo $this->escape($item->via); ?></a>
				<?php else : ?>
					<?php echo $this->escape($item->via); ?>
				<?php endif; ?>
